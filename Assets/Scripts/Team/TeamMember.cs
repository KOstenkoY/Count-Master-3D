...
public class TeamMember : MonoBehaviour
{
    ...
    private List<TeammatePoint> _teammatePoints;
    ...
    public void JoinTeam()
    {
        ...
        _teammatePoints = transform.parent.GetComponent<CreateTeamPoints>()._teammatePoints;

        foreach (TeammatePoint teammatePoint in _teammatePoints)
        {
            if (!teammatePoint.Go)
            {
    ...
    public void DiactivateStickman()
    {
